...
namespace RPGCharacterAnims
{
    ...
    public class RPGCharacterController : MonoBehaviour
    {
		...
		/// <summary>
		/// Slowtime game speed adjustment amount.
		/// </summary>
		public float slowTimeSpeed = 0.25f;
		...
		/// </summary>
		public bool canAction => _canAction && !isDead && !isSpecial && !isNavigating;
		private bool _canAction;

        /// <summary>
        /// Returns whether the character can face.
        /// </summary>
        public bool canFace => _canFace && !isDead && !isSwimming;
        ...
        /// </summary>
        public bool canStrafe => _canStrafe && !isDead && !isSwimming;
		...
		public void EndCrawl()
		{
			...
			if (ikHands) { ikHands.BlendIK(true, 1, 0.5f, (Weapon)animator.GetInteger(AnimationParameters.Weapon)); }
		}
